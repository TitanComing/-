package com.orientsec.mybatisplus.generator;
...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/mybatisplus-generator/src/main/java");
        // 是否覆盖已有文件
        ...
        pc.setParent(scanner("请输入父包名"));   //最终是： com.peng.mybatisplus
        // 父包模块名
        pc.setModuleName(scanner("请输入模块名")); //crud
        pc.setEntity("model");
        pc.setMapper("mapper");
        // pc.setService(null);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/quartz?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8");
